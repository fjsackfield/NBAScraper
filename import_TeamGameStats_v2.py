...
SQLCommand = ('INSERT INTO dbo.TeamGameStats(gameID, gameDate, homeTeamName, homeTeamAbbr,' +
...
#2012-13 Regular Season Import Complete (Except for 4 games:

dateList = ['20170223', '20170302']
for date in dateList:
    gameIDList = nba_games.create_gameIDList(date)
    game_dict = nba_games.create_team_stat_dict(gameIDList)
